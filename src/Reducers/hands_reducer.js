...
export function HandsReducer(state = {hand: null, hands: []
	...
	case "SET_HAND": 
		hand = action.payload;
		return {hand: {id: hand.id, flop: hand.flop, flopBet: hand.flopBet, holeCards: hand.holeCards, playersToFlop: hand.playersToFlop, playersToTurn: hand.playersToTurn, playersToRiver: hand.playersToRiver, playersToShowdown: hand.playersToShowdown, position: hand.position, potSize: hand.potSize, preFlopRaise: hand.preFlopRaise, river: hand.river, riverBet: hand.riverBet, status: hand.status,table_id: hand.table_id, turn: hand.turn, turnBet: hand.turnBet, tags: hand.hands_tags}, hands: state.hands.concat(action.payload.hand)};
	default:
		return state; 
	}
} 